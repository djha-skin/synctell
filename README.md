...
agent never shows up, `synctell` exits with code 124 instead of hanging
...
synctell -i pipeline/step2-input.fifo | process-image | synctell -o pipeline/step3-input.fifo
...
agents are the nodes. `synctell` is the only interface you need.
